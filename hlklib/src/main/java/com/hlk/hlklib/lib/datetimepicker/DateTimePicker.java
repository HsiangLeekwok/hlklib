...
public class DateTimePicker {
     ...
     */
    public DateTimePicker(FragmentManager fm) {
        // See if there are any DialogFragments from the FragmentManager
        FragmentTransaction ft = fm.beginTransaction();
        Fragment prev = fm.findFragmentByTag(DateTimeDialogFragment.TAG_SLIDE_DATE_TIME_DIALOG_FRAGMENT);
     ...
     * @param listener
     */
    public void setListener(DateTimeListener listener) {
        mListener = listener;
    }
    ...
    public void show() {
        ...
        DateTimeDialogFragment dialogFragment =
    ...
    public static class Builder {
        ...
        /**
         * @see DateTimePicker#setListener(DateTimeListener)
         */
        public Builder setListener(DateTimeListener listener) {
            this.listener = listener;
            return this;
        }

        /**
         * @see DateTimePicker#setInitialDate(Date)
         */
        ...
        /**
         * @see DateTimePicker#setMinDate(Date)
         */
        ...
        /**
         * @see DateTimePicker#setMaxDate(Date)
         */
        ...
        /**
         * @see DateTimePicker#setIs24HourTime(boolean)
         */
        ...
        /**
         * @see DateTimePicker#setTheme(int)
         */
        ...
        /**
         * @see DateTimePicker#setIndicatorColor(int)
         */
