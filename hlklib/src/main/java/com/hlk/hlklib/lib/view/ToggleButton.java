...
/**
 * <b>功能</b>：ToggleButton<br />
 * <b>作者</b>：Hsiang Leekwok <br />
 * <b>时间</b>：2016/01/26 20:51 <br />
...
public class ToggleButton extends View {
    ...
    public void setup(AttributeSet attrs) {
        ...
        offBorderColor = typedArray.getColor(R.styleable.ToggleButton_tb_offBorderColor, offBorderColor);
        onColor = typedArray.getColor(R.styleable.ToggleButton_tb_onColor, onColor);
        spotColor = typedArray.getColor(R.styleable.ToggleButton_tb_spotColor, spotColor);
        offColor = typedArray.getColor(R.styleable.ToggleButton_tb_offColor, offColor);
        borderWidth = typedArray.getDimensionPixelSize(R.styleable.ToggleButton_tb_borderWidth, borderWidth);
        defaultAnimate = typedArray.getBoolean(R.styleable.ToggleButton_tb_animate, defaultAnimate);
        isDefaultOn = typedArray.getBoolean(R.styleable.ToggleButton_tb_isDefaultOn, isDefaultOn);
        typedArray.recycle();
    ...
    /**
     * @param animate use animate or not
     */
    ...
    public void addOnToggleChangedListener(OnToggleChangedListener l) {
        listener = l;
    }
