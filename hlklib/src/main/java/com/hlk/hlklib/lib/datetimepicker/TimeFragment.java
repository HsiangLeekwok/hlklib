...
public class TimeFragment extends Fragment {
    ...
    /**
     * Cast the reference to {@link DateTimeDialogFragment} to a
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = localInflater.inflate(R.layout.hlklib_date_time_picker_fragment_time, container, false);

        mTimePicker = (TimePicker) v.findViewById(R.id.hlklib_datetimepicker_time_picker);
