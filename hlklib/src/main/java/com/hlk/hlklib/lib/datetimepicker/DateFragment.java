...
public class DateFragment extends Fragment
{
    ...
    /**
     * Cast the reference to {@link DateTimeDialogFragment}
            ...
            Bundle savedInstanceState)
    {
        ...
        Context contextThemeWrapper = new ContextThemeWrapper(
                getActivity(),
                theme == DateTimePicker.HOLO_DARK ?
                         android.R.style.Theme_Holo :
                         android.R.style.Theme_Holo_Light);

        LayoutInflater localInflater = inflater.cloneInContext(contextThemeWrapper);

        View v = localInflater.inflate(R.layout.hlklib_date_time_picker_fragment_date, container, false);

        mDatePicker = (CustomDatePicker) v.findViewById(R.id.hlklib_datetimepicker_date_picker);
