...
public class CustomDatePicker extends DatePicker
{
    ...
    public CustomDatePicker(Context context, AttributeSet attrs)
    {
        ...
        try
        {
            ...
            selectionDividerField.set(monthNumberPicker, getResources().getDrawable(R.drawable.hlklib_date_time_picker_selection_divider));
            selectionDividerField.set(dayNumberPicker, getResources().getDrawable(R.drawable.hlklib_date_time_picker_selection_divider));
            selectionDividerField.set(yearNumberPicker, getResources().getDrawable(R.drawable.hlklib_date_time_picker_selection_divider));
        }
