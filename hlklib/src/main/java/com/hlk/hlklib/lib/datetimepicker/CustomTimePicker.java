...
public class CustomTimePicker extends TimePicker
{
    ...
    public CustomTimePicker(Context context, AttributeSet attrs)
    {
        ...
        try
        {
            ...
            selectionDividerField.set(hourNumberPicker, getResources().getDrawable(R.drawable.hlklib_date_time_picker_selection_divider));
            selectionDividerField.set(minuteNumberPicker, getResources().getDrawable(R.drawable.hlklib_date_time_picker_selection_divider));
            selectionDividerField.set(amPmNumberPicker, getResources().getDrawable(R.drawable.hlklib_date_time_picker_selection_divider));
        }
